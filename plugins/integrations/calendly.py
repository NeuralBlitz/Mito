...
class CalendlyClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("CALENDLY_URL", "https://api.calendly.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CalendlyClient)
calendly_plugin = {"metadata": {"name": "calendly", "version": "1.0.0", "description": "Calendly Scheduling", "author": "Mito Team", "license": "MIT", "tags": ["calendly", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

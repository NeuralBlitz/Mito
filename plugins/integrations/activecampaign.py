"""ActiveCampaign CRM Plugin"""
import os
from typing import Dict, List

class ActivecampaignClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ACTIVECAMPAIGN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ACTIVECAMPAIGN_URL", "https://ACCOUNT.api-us1.com/api/3")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ActivecampaignClient)
activecampaign_plugin = {"metadata": {"name": "activecampaign", "version": "1.0.0", "description": "ActiveCampaign CRM", "author": "Mito Team", "license": "MIT", "tags": ["activecampaign", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

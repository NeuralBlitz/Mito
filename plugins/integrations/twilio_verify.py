"""Twilio Verify Plugin"""
import os
from typing import Dict, List

class TwilioVerifyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TWILIO_VERIFY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TWILIO_VERIFY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TwilioVerifyClient)
twilio_verify_plugin = {"metadata": {"name": "twilio_verify", "version": "1.0.0", "description": "Twilio phone verification", "author": "Mito Team", "license": "MIT", "tags": ["twilio_verify", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

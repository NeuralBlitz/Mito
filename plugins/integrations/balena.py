...
class BalenaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("BALENA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("BALENA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", BalenaClient)
balena_plugin = {"metadata": {"name": "balena", "version": "1.0.0", "description": "Balena edge computing", "author": "Mito Team", "license": "MIT", "tags": ["balena", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

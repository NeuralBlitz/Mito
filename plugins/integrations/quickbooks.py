...
class QuickbooksClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("QUICKBOOKS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("QUICKBOOKS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", QuickbooksClient)
quickbooks_plugin = {"metadata": {"name": "quickbooks", "version": "1.0.0", "description": "QuickBooks accounting", "author": "Mito Team", "license": "MIT", "tags": ["quickbooks", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

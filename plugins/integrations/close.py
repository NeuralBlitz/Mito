...
class CloseClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CLOSE_API_KEY", "")
        self.base_url = (base_url or os.environ.get("CLOSE_URL", "https://api.close.com/api/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CloseClient)
close_plugin = {"metadata": {"name": "close", "version": "1.0.0", "description": "Close CRM", "author": "Mito Team", "license": "MIT", "tags": ["close", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

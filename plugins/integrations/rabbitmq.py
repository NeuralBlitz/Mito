...
class RabbitmqClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("RABBITMQ_TOKEN", "")
        self.base_url = (base_url or os.environ.get("RABBITMQ_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RabbitmqClient)
rabbitmq_plugin = {"metadata": {"name": "rabbitmq", "version": "1.0.0", "description": "RabbitMQ message broker", "author": "Mito Team", "license": "MIT", "tags": ["rabbitmq", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class InstagramClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("INSTAGRAM_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", InstagramClient)
instagram_plugin = {"metadata": {"name": "instagram", "version": "1.0.0", "description": "Instagram social platform", "author": "Mito Team", "license": "MIT", "tags": ["instagram", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

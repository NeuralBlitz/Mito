...
class DynatraceClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DYNATRACE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DYNATRACE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DynatraceClient)
dynatrace_plugin = {"metadata": {"name": "dynatrace", "version": "1.0.0", "description": "Dynatrace APM platform", "author": "Mito Team", "license": "MIT", "tags": ["dynatrace", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

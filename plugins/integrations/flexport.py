"""Flexport Logistics Plugin"""
import os
from typing import Dict, List

class FlexportClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FLEXPORT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FLEXPORT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FlexportClient)
flexport_plugin = {"metadata": {"name": "flexport", "version": "1.0.0", "description": "Flexport freight forwarding", "author": "Mito Team", "license": "MIT", "tags": ["flexport", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

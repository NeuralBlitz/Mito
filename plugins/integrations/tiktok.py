...
class TiktokClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TIKTOK_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TIKTOK_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TiktokClient)
tiktok_plugin = {"metadata": {"name": "tiktok", "version": "1.0.0", "description": "TikTok social platform", "author": "Mito Team", "license": "MIT", "tags": ["tiktok", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

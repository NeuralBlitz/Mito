...
class ActivepiecesClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ACTIVEPIECES_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ACTIVEPIECES_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ActivepiecesClient)
activepieces_plugin = {"metadata": {"name": "activepieces", "version": "1.0.0", "description": "Activepieces open automation", "author": "Mito Team", "license": "MIT", "tags": ["activepieces", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

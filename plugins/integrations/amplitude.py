...
class AmplitudeClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AMPLITUDE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AMPLITUDE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AmplitudeClient)
amplitude_plugin = {"metadata": {"name": "amplitude", "version": "1.0.0", "description": "Amplitude product analytics", "author": "Mito Team", "license": "MIT", "tags": ["amplitude", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

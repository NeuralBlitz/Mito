...
def register(plugin): plugin.set_resource("client_class", PipedriveClient)
pipedrive_plugin = {"metadata": {"name": "pipedrive", "version": "1.0.0", "description": "Pipedrive CRM", "author": "Mito Team", "license": "MIT", "tags": ["pipedrive", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

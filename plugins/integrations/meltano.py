...
class MeltanoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MELTANO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MELTANO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MeltanoClient)
meltano_plugin = {"metadata": {"name": "meltano", "version": "1.0.0", "description": "Meltano data integration", "author": "Mito Team", "license": "MIT", "tags": ["meltano", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

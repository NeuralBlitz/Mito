...
class ContentfulClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CONTENTFUL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CONTENTFUL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ContentfulClient)
contentful_plugin = {"metadata": {"name": "contentful", "version": "1.0.0", "description": "Contentful headless CMS", "author": "Mito Team", "license": "MIT", "tags": ["contentful", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

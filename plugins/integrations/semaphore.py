...
class SemaphoreClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SEMAPHORE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SEMAPHORE_URL", "https://api.semaphoreci.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SemaphoreClient)
semaphore_plugin = {"metadata": {"name": "semaphore", "version": "1.0.0", "description": "Semaphore CI", "author": "Mito Team", "license": "MIT", "tags": ["semaphore", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

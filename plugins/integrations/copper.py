...
class CopperClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("COPPER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("COPPER_URL", "https://api.copper.com/developer_api/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CopperClient)
copper_plugin = {"metadata": {"name": "copper", "version": "1.0.0", "description": "Copper CRM", "author": "Mito Team", "license": "MIT", "tags": ["copper", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

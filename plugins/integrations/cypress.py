"""Cypress Testing Plugin"""
import os
from typing import Dict, List

class CypressClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CYPRESS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CYPRESS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CypressClient)
cypress_plugin = {"metadata": {"name": "cypress", "version": "1.0.0", "description": "Cypress E2E testing", "author": "Mito Team", "license": "MIT", "tags": ["cypress", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class RenderClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("RENDER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("RENDER_URL", "https://api.render.com/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RenderClient)
render_plugin = {"metadata": {"name": "render", "version": "1.0.0", "description": "Render Cloud", "author": "Mito Team", "license": "MIT", "tags": ["render", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class LabelstudioClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LABELSTUDIO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LABELSTUDIO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LabelstudioClient)
labelstudio_plugin = {"metadata": {"name": "labelstudio", "version": "1.0.0", "description": "Label Studio data labeling", "author": "Mito Team", "license": "MIT", "tags": ["labelstudio", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

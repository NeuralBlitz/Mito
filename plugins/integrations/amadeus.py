...
class AmadeusClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AMADEUS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AMADEUS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AmadeusClient)
amadeus_plugin = {"metadata": {"name": "amadeus", "version": "1.0.0", "description": "Amadeus travel API", "author": "Mito Team", "license": "MIT", "tags": ["amadeus", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class SavvycalClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SAVVYCAL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SAVVYCAL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SavvycalClient)
savvycal_plugin = {"metadata": {"name": "savvycal", "version": "1.0.0", "description": "SavvyCal scheduling", "author": "Mito Team", "license": "MIT", "tags": ["savvycal", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

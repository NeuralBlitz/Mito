...
class DocusignClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DOCUSIGN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DOCUSIGN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DocusignClient)
docusign_plugin = {"metadata": {"name": "docusign", "version": "1.0.0", "description": "DocuSign e-signatures", "author": "Mito Team", "license": "MIT", "tags": ["docusign", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class CodesandboxClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CODESANDBOX_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CODESANDBOX_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CodesandboxClient)
codesandbox_plugin = {"metadata": {"name": "codesandbox", "version": "1.0.0", "description": "CodeSandbox cloud IDE", "author": "Mito Team", "license": "MIT", "tags": ["codesandbox", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

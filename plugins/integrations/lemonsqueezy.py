...
class LemonsqueezyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LEMONSQUEEZY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LEMONSQUEEZY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LemonsqueezyClient)
lemonsqueezy_plugin = {"metadata": {"name": "lemonsqueezy", "version": "1.0.0", "description": "LemonSqueezy digital commerce", "author": "Mito Team", "license": "MIT", "tags": ["lemonsqueezy", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

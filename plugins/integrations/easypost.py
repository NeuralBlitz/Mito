"""EasyPost Shipping Plugin"""
import os
from typing import Dict, List

class EasypostClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("EASYPOST_TOKEN", "")
        self.base_url = (base_url or os.environ.get("EASYPOST_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", EasypostClient)
easypost_plugin = {"metadata": {"name": "easypost", "version": "1.0.0", "description": "EasyPost shipping API", "author": "Mito Team", "license": "MIT", "tags": ["easypost", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

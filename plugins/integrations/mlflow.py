...
class MlflowClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MLFLOW_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MLFLOW_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MlflowClient)
mlflow_plugin = {"metadata": {"name": "mlflow", "version": "1.0.0", "description": "MLflow ML lifecycle", "author": "Mito Team", "license": "MIT", "tags": ["mlflow", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class StytchClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STYTCH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STYTCH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StytchClient)
stytch_plugin = {"metadata": {"name": "stytch", "version": "1.0.0", "description": "Stytch passwordless authentication", "author": "Mito Team", "license": "MIT", "tags": ["stytch", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class CalApiClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CAL_API_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CAL_API_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CalApiClient)
cal_api_plugin = {"metadata": {"name": "cal_api", "version": "1.0.0", "description": "Cal.com scheduling API", "author": "Mito Team", "license": "MIT", "tags": ["cal_api", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

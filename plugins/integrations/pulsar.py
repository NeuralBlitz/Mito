...
class PulsarClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PULSAR_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PULSAR_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PulsarClient)
pulsar_plugin = {"metadata": {"name": "pulsar", "version": "1.0.0", "description": "Pulsar distributed messaging", "author": "Mito Team", "license": "MIT", "tags": ["pulsar", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

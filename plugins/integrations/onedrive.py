"""OneDrive Files Plugin"""
import os
from typing import Dict, List

class OnedriveClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ONEDRIVE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ONEDRIVE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", OnedriveClient)
onedrive_plugin = {"metadata": {"name": "onedrive", "version": "1.0.0", "description": "Microsoft OneDrive", "author": "Mito Team", "license": "MIT", "tags": ["onedrive", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

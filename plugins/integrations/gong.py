...
class GongClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GONG_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GONG_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GongClient)
gong_plugin = {"metadata": {"name": "gong", "version": "1.0.0", "description": "Gong revenue intelligence", "author": "Mito Team", "license": "MIT", "tags": ["gong", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

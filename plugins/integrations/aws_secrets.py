...
class AwsSecretsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_SECRETS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_SECRETS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsSecretsClient)
aws_secrets_plugin = {"metadata": {"name": "aws_secrets", "version": "1.0.0", "description": "AWS Secrets Manager", "author": "Mito Team", "license": "MIT", "tags": ["aws_secrets", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

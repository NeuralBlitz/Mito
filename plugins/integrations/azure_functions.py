...
class AzureFunctionsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AZURE_FUNCTIONS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AZURE_FUNCTIONS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AzureFunctionsClient)
azure_functions_plugin = {"metadata": {"name": "azure_functions", "version": "1.0.0", "description": "Azure serverless functions", "author": "Mito Team", "license": "MIT", "tags": ["azure_functions", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

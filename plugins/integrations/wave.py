"""Wave Accounting Plugin"""
import os
from typing import Dict, List

class WaveClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WAVE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WAVE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WaveClient)
wave_plugin = {"metadata": {"name": "wave", "version": "1.0.0", "description": "Wave free accounting", "author": "Mito Team", "license": "MIT", "tags": ["wave", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

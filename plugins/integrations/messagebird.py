...
class MessagebirdClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MESSAGEBIRD_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MESSAGEBIRD_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MessagebirdClient)
messagebird_plugin = {"metadata": {"name": "messagebird", "version": "1.0.0", "description": "MessageBird communications", "author": "Mito Team", "license": "MIT", "tags": ["messagebird", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

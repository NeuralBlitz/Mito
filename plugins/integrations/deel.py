"""Deel Global HR Plugin"""
import os
from typing import Dict, List

class DeelClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DEEL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DEEL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DeelClient)
deel_plugin = {"metadata": {"name": "deel", "version": "1.0.0", "description": "Deel global payroll", "author": "Mito Team", "license": "MIT", "tags": ["deel", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

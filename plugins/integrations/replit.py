...
class ReplitClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("REPLIT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ReplitClient)
replit_plugin = {"metadata": {"name": "replit", "version": "1.0.0", "description": "Replit cloud IDE", "author": "Mito Team", "license": "MIT", "tags": ["replit", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class LambdatestClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LAMBDATEST_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LAMBDATEST_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LambdatestClient)
lambdatest_plugin = {"metadata": {"name": "lambdatest", "version": "1.0.0", "description": "LambdaTest cloud testing", "author": "Mito Team", "license": "MIT", "tags": ["lambdatest", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class ClickupClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("CLICKUP_URL", "https://api.clickup.com/api/v2")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ClickupClient)
clickup_plugin = {"metadata": {"name": "clickup", "version": "1.0.0", "description": "ClickUp Tasks", "author": "Mito Team", "license": "MIT", "tags": ["clickup", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

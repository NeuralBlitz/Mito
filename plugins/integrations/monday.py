...
class MondayClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MONDAY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MONDAY_URL", "https://api.monday.com/v2")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MondayClient)
monday_plugin = {"metadata": {"name": "monday", "version": "1.0.0", "description": "Monday.com", "author": "Mito Team", "license": "MIT", "tags": ["monday", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

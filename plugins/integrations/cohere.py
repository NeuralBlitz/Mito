...
class CohereClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("COHERE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("COHERE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CohereClient)
cohere_plugin = {"metadata": {"name": "cohere", "version": "1.0.0", "description": "Cohere language models", "author": "Mito Team", "license": "MIT", "tags": ["cohere", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

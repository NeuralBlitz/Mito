...
class DockerHubClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DOCKER_HUB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DOCKER_HUB_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DockerHubClient)
docker_hub_plugin = {"metadata": {"name": "docker_hub", "version": "1.0.0", "description": "Docker Hub container registry", "author": "Mito Team", "license": "MIT", "tags": ["docker_hub", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

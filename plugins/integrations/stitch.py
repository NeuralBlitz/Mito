...
class StitchClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STITCH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STITCH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StitchClient)
stitch_plugin = {"metadata": {"name": "stitch", "version": "1.0.0", "description": "Stitch data integration", "author": "Mito Team", "license": "MIT", "tags": ["stitch", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

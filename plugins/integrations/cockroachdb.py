...
class CockroachdbClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("COCKROACHDB_DSN", "")
        self.base_url = (base_url or os.environ.get("COCKROACHDB_URL", "postgresql://localhost:26257")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CockroachdbClient)
cockroachdb_plugin = {"metadata": {"name": "cockroachdb", "version": "1.0.0", "description": "CockroachDB", "author": "Mito Team", "license": "MIT", "tags": ["cockroachdb", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

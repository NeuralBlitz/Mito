...
class MixpanelClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("MIXPANEL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MixpanelClient)
mixpanel_plugin = {"metadata": {"name": "mixpanel", "version": "1.0.0", "description": "Mixpanel product analytics", "author": "Mito Team", "license": "MIT", "tags": ["mixpanel", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Adyen Payments Plugin"""
import os
from typing import Dict, List

class AdyenClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ADYEN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ADYEN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AdyenClient)
adyen_plugin = {"metadata": {"name": "adyen", "version": "1.0.0", "description": "Adyen global payments", "author": "Mito Team", "license": "MIT", "tags": ["adyen", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

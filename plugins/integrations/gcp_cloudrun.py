...
class GcpCloudrunClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GCP_CLOUDRUN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GCP_CLOUDRUN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcpCloudrunClient)
gcp_cloudrun_plugin = {"metadata": {"name": "gcp_cloudrun", "version": "1.0.0", "description": "GCP Cloud Run containers", "author": "Mito Team", "license": "MIT", "tags": ["gcp_cloudrun", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class AzureServicebusClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AZURE_SERVICEBUS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AZURE_SERVICEBUS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AzureServicebusClient)
azure_servicebus_plugin = {"metadata": {"name": "azure_servicebus", "version": "1.0.0", "description": "Azure messaging", "author": "Mito Team", "license": "MIT", "tags": ["azure_servicebus", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

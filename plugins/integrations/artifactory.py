...
class ArtifactoryClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ARTIFACTORY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ARTIFACTORY_URL", "https://artifactory.local")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ArtifactoryClient)
artifactory_plugin = {"metadata": {"name": "artifactory", "version": "1.0.0", "description": "JFrog Artifactory", "author": "Mito Team", "license": "MIT", "tags": ["artifactory", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

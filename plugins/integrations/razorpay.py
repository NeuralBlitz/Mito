"""Razorpay Payments Plugin"""
import os
from typing import Dict, List

class RazorpayClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("RAZORPAY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("RAZORPAY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RazorpayClient)
razorpay_plugin = {"metadata": {"name": "razorpay", "version": "1.0.0", "description": "Razorpay payment gateway", "author": "Mito Team", "license": "MIT", "tags": ["razorpay", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

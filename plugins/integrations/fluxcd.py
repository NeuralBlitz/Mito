"""FluxCD GitOps Plugin"""
import os
from typing import Dict, List

class FluxcdClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FLUXCD_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FLUXCD_URL", "http://localhost:3000")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FluxcdClient)
fluxcd_plugin = {"metadata": {"name": "fluxcd", "version": "1.0.0", "description": "FluxCD GitOps", "author": "Mito Team", "license": "MIT", "tags": ["fluxcd", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class FullcontactClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FULLCONTACT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FULLCONTACT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FullcontactClient)
fullcontact_plugin = {"metadata": {"name": "fullcontact", "version": "1.0.0", "description": "FullContact identity resolution", "author": "Mito Team", "license": "MIT", "tags": ["fullcontact", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

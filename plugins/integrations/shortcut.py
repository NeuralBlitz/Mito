"""Shortcut Project Management Plugin"""
import os
from typing import Dict, List

class ShortcutClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SHORTCUT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SHORTCUT_URL", "https://api.app.shortcut.com/api/v3")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ShortcutClient)
shortcut_plugin = {"metadata": {"name": "shortcut", "version": "1.0.0", "description": "Shortcut Project Management", "author": "Mito Team", "license": "MIT", "tags": ["shortcut", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

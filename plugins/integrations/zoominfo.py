...
class ZoominfoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ZOOMINFO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ZOOMINFO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ZoominfoClient)
zoominfo_plugin = {"metadata": {"name": "zoominfo", "version": "1.0.0", "description": "ZoomInfo sales intelligence", "author": "Mito Team", "license": "MIT", "tags": ["zoominfo", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

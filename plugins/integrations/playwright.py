...
class PlaywrightClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PLAYWRIGHT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PLAYWRIGHT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PlaywrightClient)
playwright_plugin = {"metadata": {"name": "playwright", "version": "1.0.0", "description": "Playwright browser testing", "author": "Mito Team", "license": "MIT", "tags": ["playwright", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

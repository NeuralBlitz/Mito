...
class AlchemyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ALCHEMY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ALCHEMY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AlchemyClient)
alchemy_plugin = {"metadata": {"name": "alchemy", "version": "1.0.0", "description": "Alchemy blockchain API", "author": "Mito Team", "license": "MIT", "tags": ["alchemy", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

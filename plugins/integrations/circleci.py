...
class CircleciClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("CIRCLECI_URL", "https://circleci.com/api/v2")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CircleciClient)
circleci_plugin = {"metadata": {"name": "circleci", "version": "1.0.0", "description": "CircleCI", "author": "Mito Team", "license": "MIT", "tags": ["circleci", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

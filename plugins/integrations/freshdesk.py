"""Freshdesk Support Plugin"""
import os
from typing import Dict, List

class FreshdeskClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FRESHDESK_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FRESHDESK_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FreshdeskClient)
freshdesk_plugin = {"metadata": {"name": "freshdesk", "version": "1.0.0", "description": "Freshdesk helpdesk", "author": "Mito Team", "license": "MIT", "tags": ["freshdesk", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

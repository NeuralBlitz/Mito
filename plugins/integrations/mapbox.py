...
class MapboxClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("MAPBOX_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MapboxClient)
mapbox_plugin = {"metadata": {"name": "mapbox", "version": "1.0.0", "description": "Mapbox mapping platform", "author": "Mito Team", "license": "MIT", "tags": ["mapbox", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class MonteCarloClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MONTE_CARLO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MONTE_CARLO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MonteCarloClient)
monte_carlo_plugin = {"metadata": {"name": "monte_carlo", "version": "1.0.0", "description": "Monte Carlo data observability", "author": "Mito Team", "license": "MIT", "tags": ["monte_carlo", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

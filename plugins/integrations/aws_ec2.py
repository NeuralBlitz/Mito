...
class AwsEc2Client:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_EC2_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_EC2_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsEc2Client)
aws_ec2_plugin = {"metadata": {"name": "aws_ec2", "version": "1.0.0", "description": "AWS EC2 compute instances", "author": "Mito Team", "license": "MIT", "tags": ["aws_ec2", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

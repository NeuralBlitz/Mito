...
class GoogleDriveClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("GOOGLE_DRIVE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GoogleDriveClient)
google_drive_plugin = {"metadata": {"name": "google_drive", "version": "1.0.0", "description": "Google Drive file storage", "author": "Mito Team", "license": "MIT", "tags": ["google_drive", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

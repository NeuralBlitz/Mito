...
class BuildkiteClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("BUILDKITE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("BUILDKITE_URL", "https://api.buildkite.com/v2")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", BuildkiteClient)
buildkite_plugin = {"metadata": {"name": "buildkite", "version": "1.0.0", "description": "Buildkite CI", "author": "Mito Team", "license": "MIT", "tags": ["buildkite", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Whoop Fitness Plugin"""
import os
from typing import Dict, List

class WhoopClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WHOOP_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WHOOP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WhoopClient)
whoop_plugin = {"metadata": {"name": "whoop", "version": "1.0.0", "description": "Whoop fitness tracking", "author": "Mito Team", "license": "MIT", "tags": ["whoop", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

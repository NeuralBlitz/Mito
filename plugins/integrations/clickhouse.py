"""ClickHouse OLAP Plugin"""
import os
from typing import Dict, List

class ClickhouseClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CLICKHOUSE_API_KEY", "")
        self.base_url = (base_url or os.environ.get("CLICKHOUSE_URL", "http://localhost:8123")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ClickhouseClient)
clickhouse_plugin = {"metadata": {"name": "clickhouse", "version": "1.0.0", "description": "ClickHouse OLAP", "author": "Mito Team", "license": "MIT", "tags": ["clickhouse", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

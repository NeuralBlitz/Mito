"""Outreach Sales Plugin"""
import os
from typing import Dict, List

class OutreachClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("OUTREACH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("OUTREACH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", OutreachClient)
outreach_plugin = {"metadata": {"name": "outreach", "version": "1.0.0", "description": "Outreach sales engagement", "author": "Mito Team", "license": "MIT", "tags": ["outreach", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class FlyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FLY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FLY_URL", "https://api.fly.io/graphql")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FlyClient)
fly_plugin = {"metadata": {"name": "fly", "version": "1.0.0", "description": "Fly.io", "author": "Mito Team", "license": "MIT", "tags": ["fly", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

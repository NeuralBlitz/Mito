"""ConvertKit Email Plugin"""
import os
from typing import Dict, List

class ConvertkitClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CONVERTKIT_API_KEY", "")
        self.base_url = (base_url or os.environ.get("CONVERTKIT_URL", "https://api.convertkit.com/v3")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ConvertkitClient)
convertkit_plugin = {"metadata": {"name": "convertkit", "version": "1.0.0", "description": "ConvertKit Email", "author": "Mito Team", "license": "MIT", "tags": ["convertkit", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

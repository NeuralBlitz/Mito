...
class SalesloftClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SALESLOFT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SALESLOFT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SalesloftClient)
salesloft_plugin = {"metadata": {"name": "salesloft", "version": "1.0.0", "description": "Salesloft sales engagement", "author": "Mito Team", "license": "MIT", "tags": ["salesloft", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

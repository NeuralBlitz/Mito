...
class WandbClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WANDB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WANDB_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WandbClient)
wandb_plugin = {"metadata": {"name": "wandb", "version": "1.0.0", "description": "W&B experiment tracking", "author": "Mito Team", "license": "MIT", "tags": ["wandb", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

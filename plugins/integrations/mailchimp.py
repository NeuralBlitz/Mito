"""Mailchimp Marketing Plugin"""
import os
from typing import Dict, List

class MailchimpClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MAILCHIMP_API_KEY", "")
        self.base_url = (base_url or os.environ.get("MAILCHIMP_URL", "https://us1.api.mailchimp.com/3.0")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MailchimpClient)
mailchimp_plugin = {"metadata": {"name": "mailchimp", "version": "1.0.0", "description": "Mailchimp Marketing", "author": "Mito Team", "license": "MIT", "tags": ["mailchimp", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class VeracodeClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("VERACODE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("VERACODE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", VeracodeClient)
veracode_plugin = {"metadata": {"name": "veracode", "version": "1.0.0", "description": "Veracode application security", "author": "Mito Team", "license": "MIT", "tags": ["veracode", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

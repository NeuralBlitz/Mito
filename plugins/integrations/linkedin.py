...
class LinkedinClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LINKEDIN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LINKEDIN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LinkedinClient)
linkedin_plugin = {"metadata": {"name": "linkedin", "version": "1.0.0", "description": "LinkedIn professional network", "author": "Mito Team", "license": "MIT", "tags": ["linkedin", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Clari Revenue Plugin"""
import os
from typing import Dict, List

class ClariClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CLARI_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CLARI_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ClariClient)
clari_plugin = {"metadata": {"name": "clari", "version": "1.0.0", "description": "Clari revenue platform", "author": "Mito Team", "license": "MIT", "tags": ["clari", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

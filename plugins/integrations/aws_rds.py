...
class AwsRdsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_RDS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_RDS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsRdsClient)
aws_rds_plugin = {"metadata": {"name": "aws_rds", "version": "1.0.0", "description": "AWS Relational Database Service", "author": "Mito Team", "license": "MIT", "tags": ["aws_rds", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

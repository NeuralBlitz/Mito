...
class MuxClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MUX_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MUX_URL", "https://api.mux.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MuxClient)
mux_plugin = {"metadata": {"name": "mux", "version": "1.0.0", "description": "Mux Video", "author": "Mito Team", "license": "MIT", "tags": ["mux", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

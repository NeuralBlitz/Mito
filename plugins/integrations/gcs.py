...
class GcsClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("GCS_URL", "https://storage.googleapis.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcsClient)
gcs_plugin = {"metadata": {"name": "gcs", "version": "1.0.0", "description": "Google Cloud Storage", "author": "Mito Team", "license": "MIT", "tags": ["gcs", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

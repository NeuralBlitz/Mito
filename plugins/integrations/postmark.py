"""Postmark Email Plugin"""
import os
from typing import Dict, List

class PostmarkClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("POSTMARK_TOKEN", "")
        self.base_url = (base_url or os.environ.get("POSTMARK_URL", "https://api.postmarkapp.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PostmarkClient)
postmark_plugin = {"metadata": {"name": "postmark", "version": "1.0.0", "description": "Postmark Email", "author": "Mito Team", "license": "MIT", "tags": ["postmark", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

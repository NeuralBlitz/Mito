"""Cronofy Calendar Plugin"""
import os
from typing import Dict, List

class CronofyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CRONOFY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CRONOFY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CronofyClient)
cronofy_plugin = {"metadata": {"name": "cronofy", "version": "1.0.0", "description": "Cronofy calendar API", "author": "Mito Team", "license": "MIT", "tags": ["cronofy", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class HeightClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HEIGHT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HEIGHT_URL", "https://api.height.app")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HeightClient)
height_plugin = {"metadata": {"name": "height", "version": "1.0.0", "description": "Height App", "author": "Mito Team", "license": "MIT", "tags": ["height", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class MistralClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MISTRAL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MISTRAL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MistralClient)
mistral_plugin = {"metadata": {"name": "mistral", "version": "1.0.0", "description": "Mistral language models", "author": "Mito Team", "license": "MIT", "tags": ["mistral", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class LoomClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LOOM_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LOOM_URL", "https://www.loom.com/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LoomClient)
loom_plugin = {"metadata": {"name": "loom", "version": "1.0.0", "description": "Loom Video", "author": "Mito Team", "license": "MIT", "tags": ["loom", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

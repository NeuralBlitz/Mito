...
class AirbyteClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AIRBYTE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AIRBYTE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AirbyteClient)
airbyte_plugin = {"metadata": {"name": "airbyte", "version": "1.0.0", "description": "Airbyte open-source ETL", "author": "Mito Team", "license": "MIT", "tags": ["airbyte", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class GithubActionsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GITHUB_ACTIONS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GITHUB_ACTIONS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GithubActionsClient)
github_actions_plugin = {"metadata": {"name": "github_actions", "version": "1.0.0", "description": "GitHub Actions CI/CD", "author": "Mito Team", "license": "MIT", "tags": ["github_actions", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class SapClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("SAP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SapClient)
sap_plugin = {"metadata": {"name": "sap", "version": "1.0.0", "description": "SAP enterprise software", "author": "Mito Team", "license": "MIT", "tags": ["sap", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Twitter/X API Plugin"""
import os
from typing import Dict, List

class TwitterClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TWITTER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TWITTER_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TwitterClient)
twitter_plugin = {"metadata": {"name": "twitter", "version": "1.0.0", "description": "Twitter social platform", "author": "Mito Team", "license": "MIT", "tags": ["twitter", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

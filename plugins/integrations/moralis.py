...
class MoralisClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MORALIS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MORALIS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MoralisClient)
moralis_plugin = {"metadata": {"name": "moralis", "version": "1.0.0", "description": "Moralis Web3 API", "author": "Mito Team", "license": "MIT", "tags": ["moralis", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

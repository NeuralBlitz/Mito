...
class AzureCosmosdbClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AZURE_COSMOSDB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AZURE_COSMOSDB_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AzureCosmosdbClient)
azure_cosmosdb_plugin = {"metadata": {"name": "azure_cosmosdb", "version": "1.0.0", "description": "Azure multi-model database", "author": "Mito Team", "license": "MIT", "tags": ["azure_cosmosdb", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

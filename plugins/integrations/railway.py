...
class RailwayClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("RAILWAY_URL", "https://backboard.railway.app/graphql")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RailwayClient)
railway_plugin = {"metadata": {"name": "railway", "version": "1.0.0", "description": "Railway PaaS", "author": "Mito Team", "license": "MIT", "tags": ["railway", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

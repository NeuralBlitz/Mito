...
class MiroClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("MIRO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MiroClient)
miro_plugin = {"metadata": {"name": "miro", "version": "1.0.0", "description": "Miro collaborative whiteboard", "author": "Mito Team", "license": "MIT", "tags": ["miro", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

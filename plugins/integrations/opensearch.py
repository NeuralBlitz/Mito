...
class OpensearchClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("OPENSEARCH_API_KEY", "")
        self.base_url = (base_url or os.environ.get("OPENSEARCH_URL", "https://localhost:9200")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", OpensearchClient)
opensearch_plugin = {"metadata": {"name": "opensearch", "version": "1.0.0", "description": "OpenSearch", "author": "Mito Team", "license": "MIT", "tags": ["opensearch", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

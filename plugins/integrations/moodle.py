...
def register(plugin): plugin.set_resource("client_class", MoodleClient)
moodle_plugin = {"metadata": {"name": "moodle", "version": "1.0.0", "description": "Moodle learning platform", "author": "Mito Team", "license": "MIT", "tags": ["moodle", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

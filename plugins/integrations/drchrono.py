...
class DrchronoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DRCHRONO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DRCHRONO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DrchronoClient)
drchrono_plugin = {"metadata": {"name": "drchrono", "version": "1.0.0", "description": "DrChrono electronic health records", "author": "Mito Team", "license": "MIT", "tags": ["drchrono", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

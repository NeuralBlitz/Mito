...
class RedfinClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("REDFIN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("REDFIN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RedfinClient)
redfin_plugin = {"metadata": {"name": "redfin", "version": "1.0.0", "description": "Redfin real estate data", "author": "Mito Team", "license": "MIT", "tags": ["redfin", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

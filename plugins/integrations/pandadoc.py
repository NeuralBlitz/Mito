...
class PandadocClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PANDADOC_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PANDADOC_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PandadocClient)
pandadoc_plugin = {"metadata": {"name": "pandadoc", "version": "1.0.0", "description": "PandaDoc document automation", "author": "Mito Team", "license": "MIT", "tags": ["pandadoc", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

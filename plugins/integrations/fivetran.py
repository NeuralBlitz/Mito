...
class FivetranClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FIVETRAN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FIVETRAN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FivetranClient)
fivetran_plugin = {"metadata": {"name": "fivetran", "version": "1.0.0", "description": "Fivetran data integration", "author": "Mito Team", "license": "MIT", "tags": ["fivetran", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

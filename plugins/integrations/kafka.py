...
class KafkaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("KAFKA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("KAFKA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", KafkaClient)
kafka_plugin = {"metadata": {"name": "kafka", "version": "1.0.0", "description": "Kafka messaging and event streaming", "author": "Mito Team", "license": "MIT", "tags": ["kafka", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

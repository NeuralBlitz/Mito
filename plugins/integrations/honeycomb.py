...
class HoneycombClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HONEYCOMB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HONEYCOMB_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HoneycombClient)
honeycomb_plugin = {"metadata": {"name": "honeycomb", "version": "1.0.0", "description": "Honeycomb observability", "author": "Mito Team", "license": "MIT", "tags": ["honeycomb", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class ApolloClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("APOLLO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("APOLLO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ApolloClient)
apollo_plugin = {"metadata": {"name": "apollo", "version": "1.0.0", "description": "Apollo sales intelligence", "author": "Mito Team", "license": "MIT", "tags": ["apollo", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

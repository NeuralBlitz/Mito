...
class CrowdstrikeClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CROWDSTRIKE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CROWDSTRIKE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CrowdstrikeClient)
crowdstrike_plugin = {"metadata": {"name": "crowdstrike", "version": "1.0.0", "description": "CrowdStrike endpoint protection", "author": "Mito Team", "license": "MIT", "tags": ["crowdstrike", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

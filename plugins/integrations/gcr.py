"""Google Container Registry Plugin"""
import os
from typing import Dict, List

class GcrClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GCR_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GCR_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcrClient)
gcr_plugin = {"metadata": {"name": "gcr", "version": "1.0.0", "description": "Google Container Registry", "author": "Mito Team", "license": "MIT", "tags": ["gcr", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class SnykClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("SNYK_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SnykClient)
snyk_plugin = {"metadata": {"name": "snyk", "version": "1.0.0", "description": "Snyk vulnerability scanning", "author": "Mito Team", "license": "MIT", "tags": ["snyk", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

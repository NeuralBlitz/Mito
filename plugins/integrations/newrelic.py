...
class NewrelicClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("NEWRELIC_TOKEN", "")
        self.base_url = (base_url or os.environ.get("NEWRELIC_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", NewrelicClient)
newrelic_plugin = {"metadata": {"name": "newrelic", "version": "1.0.0", "description": "New Relic APM and observability", "author": "Mito Team", "license": "MIT", "tags": ["newrelic", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

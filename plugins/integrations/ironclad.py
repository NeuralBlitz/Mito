...
class IroncladClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("IRONCLAD_TOKEN", "")
        self.base_url = (base_url or os.environ.get("IRONCLAD_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", IroncladClient)
ironclad_plugin = {"metadata": {"name": "ironclad", "version": "1.0.0", "description": "Ironclad contract management", "author": "Mito Team", "license": "MIT", "tags": ["ironclad", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

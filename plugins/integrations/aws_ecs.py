...
class AwsEcsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_ECS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_ECS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsEcsClient)
aws_ecs_plugin = {"metadata": {"name": "aws_ecs", "version": "1.0.0", "description": "AWS Elastic Container Service", "author": "Mito Team", "license": "MIT", "tags": ["aws_ecs", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

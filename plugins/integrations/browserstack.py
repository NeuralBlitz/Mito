...
class BrowserstackClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("BROWSERSTACK_TOKEN", "")
        self.base_url = (base_url or os.environ.get("BROWSERSTACK_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", BrowserstackClient)
browserstack_plugin = {"metadata": {"name": "browserstack", "version": "1.0.0", "description": "BrowserStack cross-browser testing", "author": "Mito Team", "license": "MIT", "tags": ["browserstack", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

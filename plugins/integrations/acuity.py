"""Acuity Scheduling Plugin"""
import os
from typing import Dict, List

class AcuityClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ACUITY_API_KEY", "")
        self.base_url = (base_url or os.environ.get("ACUITY_URL", "https://acuityscheduling.com/api/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AcuityClient)
acuity_plugin = {"metadata": {"name": "acuity", "version": "1.0.0", "description": "Acuity Scheduling", "author": "Mito Team", "license": "MIT", "tags": ["acuity", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class FireworksClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FIREWORKS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FIREWORKS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FireworksClient)
fireworks_plugin = {"metadata": {"name": "fireworks", "version": "1.0.0", "description": "Fireworks AI inference", "author": "Mito Team", "license": "MIT", "tags": ["fireworks", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

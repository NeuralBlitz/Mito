...
class HellosignClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HELLOSIGN_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HELLOSIGN_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HellosignClient)
hellosign_plugin = {"metadata": {"name": "hellosign", "version": "1.0.0", "description": "HelloSign e-signatures", "author": "Mito Team", "license": "MIT", "tags": ["hellosign", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

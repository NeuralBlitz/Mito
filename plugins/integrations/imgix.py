"""Imgix Image CDN Plugin"""
import os
from typing import Dict, List

class ImgixClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("IMGIX_TOKEN", "")
        self.base_url = (base_url or os.environ.get("IMGIX_URL", "https://api.imgix.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ImgixClient)
imgix_plugin = {"metadata": {"name": "imgix", "version": "1.0.0", "description": "Imgix Image CDN", "author": "Mito Team", "license": "MIT", "tags": ["imgix", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

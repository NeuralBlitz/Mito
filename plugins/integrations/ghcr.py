"""GitHub Container Registry Plugin"""
import os
from typing import Dict, List

class GhcrClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GHCR_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GHCR_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GhcrClient)
ghcr_plugin = {"metadata": {"name": "ghcr", "version": "1.0.0", "description": "GitHub Packages", "author": "Mito Team", "license": "MIT", "tags": ["ghcr", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

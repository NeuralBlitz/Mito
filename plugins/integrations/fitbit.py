...
class FitbitClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FITBIT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FITBIT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FitbitClient)
fitbit_plugin = {"metadata": {"name": "fitbit", "version": "1.0.0", "description": "Fitbit health data", "author": "Mito Team", "license": "MIT", "tags": ["fitbit", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

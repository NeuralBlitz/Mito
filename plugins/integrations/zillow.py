...
class ZillowClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ZILLOW_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ZILLOW_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ZillowClient)
zillow_plugin = {"metadata": {"name": "zillow", "version": "1.0.0", "description": "Zillow real estate data", "author": "Mito Team", "license": "MIT", "tags": ["zillow", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

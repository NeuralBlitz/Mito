"""Paddle SaaS Billing Plugin"""
import os
from typing import Dict, List

class PaddleClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PADDLE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PADDLE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PaddleClient)
paddle_plugin = {"metadata": {"name": "paddle", "version": "1.0.0", "description": "Paddle subscription billing", "author": "Mito Team", "license": "MIT", "tags": ["paddle", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

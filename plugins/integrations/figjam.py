...
class FigjamClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FIGJAM_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FIGJAM_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FigjamClient)
figjam_plugin = {"metadata": {"name": "figjam", "version": "1.0.0", "description": "FigJam collaborative whiteboard", "author": "Mito Team", "license": "MIT", "tags": ["figjam", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class AwsLambdaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_LAMBDA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_LAMBDA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsLambdaClient)
aws_lambda_plugin = {"metadata": {"name": "aws_lambda", "version": "1.0.0", "description": "AWS serverless functions", "author": "Mito Team", "license": "MIT", "tags": ["aws_lambda", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

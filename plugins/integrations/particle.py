...
class ParticleClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PARTICLE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PARTICLE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ParticleClient)
particle_plugin = {"metadata": {"name": "particle", "version": "1.0.0", "description": "Particle IoT platform", "author": "Mito Team", "license": "MIT", "tags": ["particle", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

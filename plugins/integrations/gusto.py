"""Gusto Payroll Plugin"""
import os
from typing import Dict, List

class GustoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GUSTO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GUSTO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GustoClient)
gusto_plugin = {"metadata": {"name": "gusto", "version": "1.0.0", "description": "Gusto payroll and HR", "author": "Mito Team", "license": "MIT", "tags": ["gusto", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class PrismicClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PRISMIC_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PRISMIC_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PrismicClient)
prismic_plugin = {"metadata": {"name": "prismic", "version": "1.0.0", "description": "Prismic headless CMS", "author": "Mito Team", "license": "MIT", "tags": ["prismic", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class CanvasClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("CANVAS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CanvasClient)
canvas_plugin = {"metadata": {"name": "canvas", "version": "1.0.0", "description": "Canvas learning management", "author": "Mito Team", "license": "MIT", "tags": ["canvas", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

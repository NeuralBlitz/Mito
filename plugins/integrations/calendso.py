"""Cal.com (Calendso) Plugin"""
import os
from typing import Dict, List

class CalendsoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CALENDSO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CALENDSO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CalendsoClient)
calendso_plugin = {"metadata": {"name": "calendso", "version": "1.0.0", "description": "Cal.com open scheduling", "author": "Mito Team", "license": "MIT", "tags": ["calendso", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

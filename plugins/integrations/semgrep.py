...
class SemgrepClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SEMGREP_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SEMGREP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SemgrepClient)
semgrep_plugin = {"metadata": {"name": "semgrep", "version": "1.0.0", "description": "Semgrep static analysis", "author": "Mito Team", "license": "MIT", "tags": ["semgrep", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

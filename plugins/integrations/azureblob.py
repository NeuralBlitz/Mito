...
class AzureblobClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AZUREBLOB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AZUREBLOB_URL", "https://ACCOUNT.blob.core.windows.net")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AzureblobClient)
azureblob_plugin = {"metadata": {"name": "azureblob", "version": "1.0.0", "description": "Azure Blob Storage", "author": "Mito Team", "license": "MIT", "tags": ["azureblob", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

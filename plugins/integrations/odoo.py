...
class OdooClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ODOO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ODOO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", OdooClient)
odoo_plugin = {"metadata": {"name": "odoo", "version": "1.0.0", "description": "Odoo open-source ERP", "author": "Mito Team", "license": "MIT", "tags": ["odoo", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

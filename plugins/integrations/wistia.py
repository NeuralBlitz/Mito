...
class WistiaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WISTIA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WISTIA_URL", "https://api.wistia.com/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WistiaClient)
wistia_plugin = {"metadata": {"name": "wistia", "version": "1.0.0", "description": "Wistia Video", "author": "Mito Team", "license": "MIT", "tags": ["wistia", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

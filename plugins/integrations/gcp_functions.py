...
class GcpFunctionsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GCP_FUNCTIONS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GCP_FUNCTIONS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcpFunctionsClient)
gcp_functions_plugin = {"metadata": {"name": "gcp_functions", "version": "1.0.0", "description": "GCP serverless functions", "author": "Mito Team", "license": "MIT", "tags": ["gcp_functions", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

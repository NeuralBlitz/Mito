...
class BoxClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("BOX_TOKEN", "")
        self.base_url = (base_url or os.environ.get("BOX_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", BoxClient)
box_plugin = {"metadata": {"name": "box", "version": "1.0.0", "description": "Box cloud content management", "author": "Mito Team", "license": "MIT", "tags": ["box", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

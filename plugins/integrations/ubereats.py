...
class UbereatsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("UBEREATS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("UBEREATS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", UbereatsClient)
ubereats_plugin = {"metadata": {"name": "ubereats", "version": "1.0.0", "description": "Uber Eats delivery", "author": "Mito Team", "license": "MIT", "tags": ["ubereats", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

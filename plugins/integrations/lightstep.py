...
class LightstepClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("LIGHTSTEP_TOKEN", "")
        self.base_url = (base_url or os.environ.get("LIGHTSTEP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", LightstepClient)
lightstep_plugin = {"metadata": {"name": "lightstep", "version": "1.0.0", "description": "Lightstep observability", "author": "Mito Team", "license": "MIT", "tags": ["lightstep", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

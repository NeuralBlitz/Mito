...
class RipplingClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("RIPPLING_TOKEN", "")
        self.base_url = (base_url or os.environ.get("RIPPLING_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RipplingClient)
rippling_plugin = {"metadata": {"name": "rippling", "version": "1.0.0", "description": "Rippling HR platform", "author": "Mito Team", "license": "MIT", "tags": ["rippling", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class VaultClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("VAULT_URL", "http://localhost:8200")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", VaultClient)
vault_plugin = {"metadata": {"name": "vault", "version": "1.0.0", "description": "HashiCorp Vault", "author": "Mito Team", "license": "MIT", "tags": ["vault", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

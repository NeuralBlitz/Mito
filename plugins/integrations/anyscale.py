...
class AnyscaleClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ANYSCALE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ANYSCALE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AnyscaleClient)
anyscale_plugin = {"metadata": {"name": "anyscale", "version": "1.0.0", "description": "Anyscale Ray-based inference", "author": "Mito Team", "license": "MIT", "tags": ["anyscale", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

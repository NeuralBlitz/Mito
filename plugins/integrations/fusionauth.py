...
class FusionauthClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FUSIONAUTH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FUSIONAUTH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FusionauthClient)
fusionauth_plugin = {"metadata": {"name": "fusionauth", "version": "1.0.0", "description": "FusionAuth identity platform", "author": "Mito Team", "license": "MIT", "tags": ["fusionauth", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

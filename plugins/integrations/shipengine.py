...
class ShipengineClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SHIPENGINE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SHIPENGINE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ShipengineClient)
shipengine_plugin = {"metadata": {"name": "shipengine", "version": "1.0.0", "description": "ShipEngine shipping platform", "author": "Mito Team", "license": "MIT", "tags": ["shipengine", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class GcpPubsubClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GCP_PUBSUB_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GCP_PUBSUB_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcpPubsubClient)
gcp_pubsub_plugin = {"metadata": {"name": "gcp_pubsub", "version": "1.0.0", "description": "GCP Pub/Sub messaging", "author": "Mito Team", "license": "MIT", "tags": ["gcp_pubsub", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

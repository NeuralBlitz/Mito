...
class ResendClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("RESEND_TOKEN", "")
        self.base_url = (base_url or os.environ.get("RESEND_URL", "https://api.resend.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ResendClient)
resend_plugin = {"metadata": {"name": "resend", "version": "1.0.0", "description": "Resend Email", "author": "Mito Team", "license": "MIT", "tags": ["resend", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

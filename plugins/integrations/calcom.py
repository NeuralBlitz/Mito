"""Cal.com Scheduling Plugin"""
import os
from typing import Dict, List

class CalcomClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CALCOM_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CALCOM_URL", "https://api.cal.com/v1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CalcomClient)
calcom_plugin = {"metadata": {"name": "calcom", "version": "1.0.0", "description": "Cal.com Scheduling", "author": "Mito Team", "license": "MIT", "tags": ["calcom", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Turborepo Remote Cache Plugin"""
import os
from typing import Dict, List

class TurborepoClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TURBOREPO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TURBOREPO_URL", "https://turbo.build")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TurborepoClient)
turborepo_plugin = {"metadata": {"name": "turborepo", "version": "1.0.0", "description": "Turborepo Remote Cache", "author": "Mito Team", "license": "MIT", "tags": ["turborepo", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class AvalaraClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AVALARA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AVALARA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AvalaraClient)
avalara_plugin = {"metadata": {"name": "avalara", "version": "1.0.0", "description": "Avalara tax compliance", "author": "Mito Team", "license": "MIT", "tags": ["avalara", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

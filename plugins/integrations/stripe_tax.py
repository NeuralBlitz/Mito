...
class StripeTaxClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STRIPE_TAX_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STRIPE_TAX_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StripeTaxClient)
stripe_tax_plugin = {"metadata": {"name": "stripe_tax", "version": "1.0.0", "description": "Stripe tax calculation", "author": "Mito Team", "license": "MIT", "tags": ["stripe_tax", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

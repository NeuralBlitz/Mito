...
class DropboxClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("DROPBOX_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DropboxClient)
dropbox_plugin = {"metadata": {"name": "dropbox", "version": "1.0.0", "description": "Dropbox file storage", "author": "Mito Team", "license": "MIT", "tags": ["dropbox", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

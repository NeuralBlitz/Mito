...
class DvcClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DVC_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DVC_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DvcClient)
dvc_plugin = {"metadata": {"name": "dvc", "version": "1.0.0", "description": "DVC data version control", "author": "Mito Team", "license": "MIT", "tags": ["dvc", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class WindmillClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WINDMILL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WINDMILL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WindmillClient)
windmill_plugin = {"metadata": {"name": "windmill", "version": "1.0.0", "description": "Windmill workflow engine", "author": "Mito Team", "license": "MIT", "tags": ["windmill", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

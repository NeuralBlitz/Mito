...
class DriftClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DRIFT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DRIFT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DriftClient)
drift_plugin = {"metadata": {"name": "drift", "version": "1.0.0", "description": "Drift conversational marketing", "author": "Mito Team", "license": "MIT", "tags": ["drift", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

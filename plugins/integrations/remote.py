...
class RemoteClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("REMOTE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("REMOTE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", RemoteClient)
remote_plugin = {"metadata": {"name": "remote", "version": "1.0.0", "description": "Remote global employment", "author": "Mito Team", "license": "MIT", "tags": ["remote", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

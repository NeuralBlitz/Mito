...
class TogetherClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TOGETHER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TOGETHER_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TogetherClient)
together_plugin = {"metadata": {"name": "together", "version": "1.0.0", "description": "Together AI inference", "author": "Mito Team", "license": "MIT", "tags": ["together", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

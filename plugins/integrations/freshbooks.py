...
class FreshbooksClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("FRESHBOOKS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("FRESHBOOKS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", FreshbooksClient)
freshbooks_plugin = {"metadata": {"name": "freshbooks", "version": "1.0.0", "description": "FreshBooks invoicing", "author": "Mito Team", "license": "MIT", "tags": ["freshbooks", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

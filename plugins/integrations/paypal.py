...
class PaypalClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PAYPAL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PAYPAL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PaypalClient)
paypal_plugin = {"metadata": {"name": "paypal", "version": "1.0.0", "description": "PayPal checkout and payments", "author": "Mito Team", "license": "MIT", "tags": ["paypal", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

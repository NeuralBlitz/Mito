...
class XeroClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("XERO_TOKEN", "")
        self.base_url = (base_url or os.environ.get("XERO_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", XeroClient)
xero_plugin = {"metadata": {"name": "xero", "version": "1.0.0", "description": "Xero cloud accounting", "author": "Mito Team", "license": "MIT", "tags": ["xero", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class DoordashClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DOORDASH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DOORDASH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DoordashClient)
doordash_plugin = {"metadata": {"name": "doordash", "version": "1.0.0", "description": "DoorDash delivery", "author": "Mito Team", "license": "MIT", "tags": ["doordash", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

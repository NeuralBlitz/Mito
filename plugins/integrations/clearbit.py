"""Clearbit Enrichment Plugin"""
import os
from typing import Dict, List

class ClearbitClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CLEARBIT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CLEARBIT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ClearbitClient)
clearbit_plugin = {"metadata": {"name": "clearbit", "version": "1.0.0", "description": "Clearbit data enrichment", "author": "Mito Team", "license": "MIT", "tags": ["clearbit", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class SupertokensClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SUPERTOKENS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SUPERTOKENS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SupertokensClient)
supertokens_plugin = {"metadata": {"name": "supertokens", "version": "1.0.0", "description": "SuperTokens session management", "author": "Mito Team", "license": "MIT", "tags": ["supertokens", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

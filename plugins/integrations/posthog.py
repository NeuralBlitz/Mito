...
class PosthogClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("POSTHOG_TOKEN", "")
        self.base_url = (base_url or os.environ.get("POSTHOG_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PosthogClient)
posthog_plugin = {"metadata": {"name": "posthog", "version": "1.0.0", "description": "PostHog open-source analytics", "author": "Mito Team", "license": "MIT", "tags": ["posthog", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class NetsuiteClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("NETSUITE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("NETSUITE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", NetsuiteClient)
netsuite_plugin = {"metadata": {"name": "netsuite", "version": "1.0.0", "description": "NetSuite ERP platform", "author": "Mito Team", "license": "MIT", "tags": ["netsuite", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

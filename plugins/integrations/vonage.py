"""Vonage Communications Plugin"""
import os
from typing import Dict, List

class VonageClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("VONAGE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("VONAGE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", VonageClient)
vonage_plugin = {"metadata": {"name": "vonage", "version": "1.0.0", "description": "Vonage SMS, voice, video", "author": "Mito Team", "license": "MIT", "tags": ["vonage", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

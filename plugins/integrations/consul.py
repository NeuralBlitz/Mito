...
class ConsulClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("CONSUL_URL", "http://localhost:8500")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ConsulClient)
consul_plugin = {"metadata": {"name": "consul", "version": "1.0.0", "description": "HashiCorp Consul", "author": "Mito Team", "license": "MIT", "tags": ["consul", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""WorkOS Enterprise Auth Plugin"""
import os
from typing import Dict, List

class WorkosClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("WORKOS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("WORKOS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", WorkosClient)
workos_plugin = {"metadata": {"name": "workos", "version": "1.0.0", "description": "WorkOS SSO, SCIM, directory sync", "author": "Mito Team", "license": "MIT", "tags": ["workos", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

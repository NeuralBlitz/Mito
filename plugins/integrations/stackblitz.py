...
class StackblitzClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STACKBLITZ_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STACKBLITZ_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StackblitzClient)
stackblitz_plugin = {"metadata": {"name": "stackblitz", "version": "1.0.0", "description": "StackBlitz online IDE", "author": "Mito Team", "license": "MIT", "tags": ["stackblitz", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

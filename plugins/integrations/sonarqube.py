...
class SonarqubeClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("SONARQUBE_URL", "http://localhost:9000")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SonarqubeClient)
sonarqube_plugin = {"metadata": {"name": "sonarqube", "version": "1.0.0", "description": "SonarQube Code Quality", "author": "Mito Team", "license": "MIT", "tags": ["sonarqube", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

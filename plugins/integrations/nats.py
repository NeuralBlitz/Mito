"""NATS Messaging Plugin"""
import os
from typing import Dict, List

class NatsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("NATS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("NATS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", NatsClient)
nats_plugin = {"metadata": {"name": "nats", "version": "1.0.0", "description": "NATS lightweight messaging", "author": "Mito Team", "license": "MIT", "tags": ["nats", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

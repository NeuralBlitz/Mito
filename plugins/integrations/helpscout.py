...
class HelpscoutClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HELPSCOUT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HELPSCOUT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HelpscoutClient)
helpscout_plugin = {"metadata": {"name": "helpscout", "version": "1.0.0", "description": "Help Scout customer support", "author": "Mito Team", "license": "MIT", "tags": ["helpscout", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Duffel Flights Plugin"""
import os
from typing import Dict, List

class DuffelClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("DUFFEL_TOKEN", "")
        self.base_url = (base_url or os.environ.get("DUFFEL_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", DuffelClient)
duffel_plugin = {"metadata": {"name": "duffel", "version": "1.0.0", "description": "Duffel flight booking", "author": "Mito Team", "license": "MIT", "tags": ["duffel", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Penpot Design Plugin"""
import os
from typing import Dict, List

class PenpotClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("PENPOT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("PENPOT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", PenpotClient)
penpot_plugin = {"metadata": {"name": "penpot", "version": "1.0.0", "description": "Penpot open-source design", "author": "Mito Team", "license": "MIT", "tags": ["penpot", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

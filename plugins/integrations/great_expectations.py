...
class GreatExpectationsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GREAT_EXPECTATIONS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GREAT_EXPECTATIONS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GreatExpectationsClient)
great_expectations_plugin = {"metadata": {"name": "great_expectations", "version": "1.0.0", "description": "Data quality validation", "author": "Mito Team", "license": "MIT", "tags": ["great_expectations", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

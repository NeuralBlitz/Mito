...
class InfluxdbClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("INFLUXDB_URL", "http://localhost:8086")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", InfluxdbClient)
influxdb_plugin = {"metadata": {"name": "influxdb", "version": "1.0.0", "description": "InfluxDB Time Series", "author": "Mito Team", "license": "MIT", "tags": ["influxdb", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Cloudinary Media Plugin"""
import os
from typing import Dict, List

class CloudinaryClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CLOUDINARY_API_SECRET", "")
        self.base_url = (base_url or os.environ.get("CLOUDINARY_URL", "https://api.cloudinary.com/v1_1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CloudinaryClient)
cloudinary_plugin = {"metadata": {"name": "cloudinary", "version": "1.0.0", "description": "Cloudinary Media", "author": "Mito Team", "license": "MIT", "tags": ["cloudinary", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class CrispClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CRISP_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CRISP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CrispClient)
crisp_plugin = {"metadata": {"name": "crisp", "version": "1.0.0", "description": "Crisp customer messaging", "author": "Mito Team", "license": "MIT", "tags": ["crisp", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

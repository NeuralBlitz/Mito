"""Hopper Travel Plugin"""
import os
from typing import Dict, List

class HopperClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HOPPER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HOPPER_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HopperClient)
hopper_plugin = {"metadata": {"name": "hopper", "version": "1.0.0", "description": "Hopper travel predictions", "author": "Mito Team", "license": "MIT", "tags": ["hopper", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

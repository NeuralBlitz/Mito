...
class AlgoliaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ALGOLIA_API_KEY", "")
        self.base_url = (base_url or os.environ.get("ALGOLIA_URL", "https://YOUR_APP_ID-dsn.algolia.net/1")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AlgoliaClient)
algolia_plugin = {"metadata": {"name": "algolia", "version": "1.0.0", "description": "Algolia Search", "author": "Mito Team", "license": "MIT", "tags": ["algolia", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

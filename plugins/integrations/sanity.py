...
class SanityClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("SANITY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SanityClient)
sanity_plugin = {"metadata": {"name": "sanity", "version": "1.0.0", "description": "Sanity structured content", "author": "Mito Team", "license": "MIT", "tags": ["sanity", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

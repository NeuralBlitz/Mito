...
class MaptilerClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MAPTILER_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MAPTILER_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MaptilerClient)
maptiler_plugin = {"metadata": {"name": "maptiler", "version": "1.0.0", "description": "MapTiler map tiles", "author": "Mito Team", "license": "MIT", "tags": ["maptiler", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Storyblok CMS Plugin"""
import os
from typing import Dict, List

class StoryblokClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STORYBLOK_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STORYBLOK_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StoryblokClient)
storyblok_plugin = {"metadata": {"name": "storyblok", "version": "1.0.0", "description": "Storyblok headless CMS", "author": "Mito Team", "license": "MIT", "tags": ["storyblok", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

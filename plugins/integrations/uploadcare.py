"""Uploadcare CDN Plugin"""
import os
from typing import Dict, List

class UploadcareClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("UPLOADCARE_SECRET_KEY", "")
        self.base_url = (base_url or os.environ.get("UPLOADCARE_URL", "https://api.uploadcare.com")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", UploadcareClient)
uploadcare_plugin = {"metadata": {"name": "uploadcare", "version": "1.0.0", "description": "Uploadcare CDN", "author": "Mito Team", "license": "MIT", "tags": ["uploadcare", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class CodecovClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CODECOV_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CODECOV_URL", "https://api.codecov.io")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CodecovClient)
codecov_plugin = {"metadata": {"name": "codecov", "version": "1.0.0", "description": "Codecov Coverage", "author": "Mito Team", "license": "MIT", "tags": ["codecov", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

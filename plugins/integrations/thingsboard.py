"""ThingsBoard IoT Plugin"""
import os
from typing import Dict, List

class ThingsboardClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("THINGSBOARD_TOKEN", "")
        self.base_url = (base_url or os.environ.get("THINGSBOARD_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ThingsboardClient)
thingsboard_plugin = {"metadata": {"name": "thingsboard", "version": "1.0.0", "description": "ThingsBoard IoT platform", "author": "Mito Team", "license": "MIT", "tags": ["thingsboard", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

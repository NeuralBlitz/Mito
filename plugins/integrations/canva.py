...
class CanvaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("CANVA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("CANVA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", CanvaClient)
canva_plugin = {"metadata": {"name": "canva", "version": "1.0.0", "description": "Canva design platform", "author": "Mito Team", "license": "MIT", "tags": ["canva", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

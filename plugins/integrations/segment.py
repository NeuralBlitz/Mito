...
class SegmentClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("SEGMENT_TOKEN", "")
        self.base_url = (base_url or os.environ.get("SEGMENT_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", SegmentClient)
segment_plugin = {"metadata": {"name": "segment", "version": "1.0.0", "description": "Segment customer data platform", "author": "Mito Team", "license": "MIT", "tags": ["segment", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

"""Heap Analytics Plugin"""
import os
from typing import Dict, List

class HeapClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HEAP_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HEAP_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HeapClient)
heap_plugin = {"metadata": {"name": "heap", "version": "1.0.0", "description": "Heap automatic event capture", "author": "Mito Team", "license": "MIT", "tags": ["heap", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

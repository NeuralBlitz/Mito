...
class TypesenseClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TYPESENSE_API_KEY", "")
        self.base_url = (base_url or os.environ.get("TYPESENSE_URL", "http://localhost:8108")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TypesenseClient)
typesense_plugin = {"metadata": {"name": "typesense", "version": "1.0.0", "description": "Typesense Search", "author": "Mito Team", "license": "MIT", "tags": ["typesense", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

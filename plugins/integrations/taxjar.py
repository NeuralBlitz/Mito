...
class TaxjarClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TAXJAR_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TAXJAR_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TaxjarClient)
taxjar_plugin = {"metadata": {"name": "taxjar", "version": "1.0.0", "description": "TaxJar sales tax automation", "author": "Mito Team", "license": "MIT", "tags": ["taxjar", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

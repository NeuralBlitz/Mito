...
class MakeClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("MAKE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("MAKE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", MakeClient)
make_plugin = {"metadata": {"name": "make", "version": "1.0.0", "description": "Make automation platform", "author": "Mito Team", "license": "MIT", "tags": ["make", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class NomadClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("NOMAD_URL", "http://localhost:4646")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", NomadClient)
nomad_plugin = {"metadata": {"name": "nomad", "version": "1.0.0", "description": "HashiCorp Nomad", "author": "Mito Team", "license": "MIT", "tags": ["nomad", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

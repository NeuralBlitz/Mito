"""Strava Fitness Plugin"""
import os
from typing import Dict, List

class StravaClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("STRAVA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("STRAVA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StravaClient)
strava_plugin = {"metadata": {"name": "strava", "version": "1.0.0", "description": "Strava fitness tracking", "author": "Mito Team", "license": "MIT", "tags": ["strava", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

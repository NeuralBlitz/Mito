...
class StrapiClient:
    def __init__(self, token: str = None, base_url: str = None):
        ...
        self.base_url = (base_url or os.environ.get("STRAPI_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", StrapiClient)
strapi_plugin = {"metadata": {"name": "strapi", "version": "1.0.0", "description": "Strapi headless CMS", "author": "Mito Team", "license": "MIT", "tags": ["strapi", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

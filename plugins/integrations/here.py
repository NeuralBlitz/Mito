...
class HereClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("HERE_TOKEN", "")
        self.base_url = (base_url or os.environ.get("HERE_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", HereClient)
here_plugin = {"metadata": {"name": "here", "version": "1.0.0", "description": "HERE location services", "author": "Mito Team", "license": "MIT", "tags": ["here", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

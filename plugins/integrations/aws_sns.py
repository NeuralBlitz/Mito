...
class AwsSnsClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("AWS_SNS_TOKEN", "")
        self.base_url = (base_url or os.environ.get("AWS_SNS_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AwsSnsClient)
aws_sns_plugin = {"metadata": {"name": "aws_sns", "version": "1.0.0", "description": "AWS Simple Notification Service", "author": "Mito Team", "license": "MIT", "tags": ["aws_sns", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

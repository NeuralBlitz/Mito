...
class EcrClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ECR_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ECR_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", EcrClient)
ecr_plugin = {"metadata": {"name": "ecr", "version": "1.0.0", "description": "AWS Elastic Container Registry", "author": "Mito Team", "license": "MIT", "tags": ["ecr", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

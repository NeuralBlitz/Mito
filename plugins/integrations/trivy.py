"""Trivy Container Security Plugin"""
import os
from typing import Dict, List

class TrivyClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TRIVY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TRIVY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", TrivyClient)
trivy_plugin = {"metadata": {"name": "trivy", "version": "1.0.0", "description": "Trivy vulnerability scanner", "author": "Mito Team", "license": "MIT", "tags": ["trivy", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class AthenahealthClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("ATHENAHEALTH_TOKEN", "")
        self.base_url = (base_url or os.environ.get("ATHENAHEALTH_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", AthenahealthClient)
athenahealth_plugin = {"metadata": {"name": "athenahealth", "version": "1.0.0", "description": "Athenahealth EHR", "author": "Mito Team", "license": "MIT", "tags": ["athenahealth", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

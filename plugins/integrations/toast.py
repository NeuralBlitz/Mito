"""Toast Restaurant Plugin"""
import os
from typing import Dict, List

class ToastClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("TOAST_TOKEN", "")
        self.base_url = (base_url or os.environ.get("TOAST_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", ToastClient)
toast_plugin = {"metadata": {"name": "toast", "version": "1.0.0", "description": "Toast restaurant POS", "author": "Mito Team", "license": "MIT", "tags": ["toast", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class GcpBigqueryClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("GCP_BIGQUERY_TOKEN", "")
        self.base_url = (base_url or os.environ.get("GCP_BIGQUERY_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", GcpBigqueryClient)
gcp_bigquery_plugin = {"metadata": {"name": "gcp_bigquery", "version": "1.0.0", "description": "GCP BigQuery analytics", "author": "Mito Team", "license": "MIT", "tags": ["gcp_bigquery", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}

...
class InfuraClient:
    def __init__(self, token: str = None, base_url: str = None):
        self.token = token or os.environ.get("INFURA_TOKEN", "")
        self.base_url = (base_url or os.environ.get("INFURA_URL", "")).rstrip("/")
...
def register(plugin): plugin.set_resource("client_class", InfuraClient)
infura_plugin = {"metadata": {"name": "infura", "version": "1.0.0", "description": "Infura Ethereum API", "author": "Mito Team", "license": "MIT", "tags": ["infura", "integration"], "permissions": ["network_access", "read_env"], "min_mito_version": "1.0.0"}, "register": register}
